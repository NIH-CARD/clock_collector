...
MoCA clock item (0–3), Shulman 5-point, Sunderland 10-point, and Rouleau-style
qualitative error analysis. This is a screening-awareness prototype — **not a
diagnosis and not a validated instrument**. Keep that framing in the prompt.
...
SYSTEM_PROMPT = (
    ...
    "Sunderland 10-point scale, and Rouleau-style qualitative error analysis "
...
def build_user_prompt(target_hour: int, target_minute: int,
    ...
    return (
        ...
        f"The drawer was asked to set the hands to the current time: {target} "
        "(24-hour). A 12-hour clock face showing the same hour/minute counts as a "
        "match (e.g. 23:10 drawn as 11:10 is correct).\n\n"
        ...
        "Score the drawing against the MoCA clock item, the Shulman 5-point and "
        "Sunderland 10-point scales, and list any Rouleau-style qualitative "
